...
#             print(file)
            content=f.read()
            contentDict,U,totalCount=preprocess(content,U,totalCount)
#         print(contentDict)
        X.append(contentDict)
        # if c==10:
        #     break
        # c+=1
    return X,y,U,totalCount
...
spamX,spamY,U,totalCount=readData(SPAM_PATH,1,U,totalCount)
hamX,hamY,U,totalCount=readData(HAM_PATH,0,U,totalCount)
# print(U)
